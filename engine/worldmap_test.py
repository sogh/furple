...
class WorldMapTest(unittest.TestCase):
    ...
    def test_retrieve_item(self):
        self.assertEqual(self.test_worldmap.pickupitems(1,0,self.test_detritus_description).description, self.test_detritus_description)
        self.assertEqual(self.test_worldmap.pickupitems(1,0,self.test_detritus_description), "You cannot get that.") 
